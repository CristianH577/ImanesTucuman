...
export const SVGCuadrado = ({ fill, size, height, width, ...props }) => (
  <svg
    ...
    stroke={props?.stroke || "currentColor"}
    width={size * 61 || width || 61}
    height={size * 49 || height || 49}
    {...props}
  >
    <path
...
export const SVGRedondoFresado = ({ fill, size, height, width, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 125 86"
    fill={fill || "none"}
    stroke={props?.stroke || "currentColor"}
    width={size * 125 || width || 125}
    height={size * 86 || height || 86}
    {...props}
  >
...
//MEDIDAS
export const SVGCuadradoMeasures = ({
  fill,
  size,
  height,
  width,
...
export const SVGCuadradoFresadoMeasures = ({
  fill,
  size,
  height,
  width,
...
export const SVGRedondoMeasures = ({ fill, size, height, width, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 140 90"
    fill={fill || "currentColor"}
...
export const SVGRedondoFresadoMeasures = ({
  fill,
  stroke,
  size,
  height,
...
export const SVGDragMagnetMeasures = ({
  fill,
  stroke,
  size,
  height,
