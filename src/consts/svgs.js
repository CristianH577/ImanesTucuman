...
export const SVGRedondoFresado = ({
  fill,
  stroke,
  size,
  height,
...
export const SVGCuadradoFresado = ({ fill, size, height, width, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 102 64"
    fill={fill || "currentColor"}
    stroke="none"
    width={size * 102 || width || 102}
    height={size * 64 || height || 64}
    {...props}
  >
    <path
