...
import { Tabs, Tab, Image, Divider, Button } from "@nextui-org/react";

import SectionView from "../components/SectionView";

import db from "../assets/otros/db-otros.json";
            ...
            >
              {data.map((cat) => (
                <Tab key={cat.id} title={cat.label}>
                  <motion.article
                    className="overflow-auto h-[800px] w-full md:w-auto scrollbar scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-custom1 scrollbar-track-custom2 scrollbar-w-3 scrollbar-h-3 hover:scrollbar-thumb-custom1-6"
                    variants={{
                      hidden: {},
                      visible: {
                        transition: {
